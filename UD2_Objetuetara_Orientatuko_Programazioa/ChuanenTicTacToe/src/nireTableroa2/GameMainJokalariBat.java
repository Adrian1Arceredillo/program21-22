 ...
 */
public class GameMainJokalariBat {
    ...
    public void updateGame(Seed theSeed) {
        if (board.finalJuego(theSeed)) {  // check for win
            currentState = GameState.CRUZ_GANA;
    ...
    public static void main(String[] args) {
        new GameMainJokalariBat();  // Let the constructor do the job
    }
}
