...
public class ThreeFiveSevenSum {  // Save as "OddEvenSum.java"
   public static void main(String[] args) {
       ...
       while (number <= bukaera) {
          if ((number % div1 == 0 || number % div2 == 0 || number % div3 == 0)){  //divisile entre 3, 5 y 7
              if ((number % nodiv1 != 0 && number % nodiv2 != 0 && number % nodiv3 != 0 && number % nodiv4 != 0)) {  //no divisible entre 15, 21, 35 y 105 
